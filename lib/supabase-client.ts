...
console.log("[Supabase Client] Anon Key (first 5 chars):", supabaseAnonKey ? supabaseAnonKey.substring(0, 5) + '...' : 'N/A');
...
export async function searchRestaurants(
  ...
  while (retries < maxRetries) {
    ...
    // Log the initial query object (before applying filters)
    ...
    // Log the final query object (after applying filters and pagination)
