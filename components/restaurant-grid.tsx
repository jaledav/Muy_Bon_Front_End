...
import { getBestRestaurantImage } from "@/lib/utils"
    ...
    <div>
      ...
      <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
        ...
        {restaurants.map((restaurant) => {
          if (restaurant.id === "a328c4a8-3049-470b-8359-7bc0d57dc50a") {
            // eslint-disable-next-line no-console
            console.log("DEBUG: Directory restaurant object:", restaurant)
          }
          return (
            <Card
              key={restaurant.id}
